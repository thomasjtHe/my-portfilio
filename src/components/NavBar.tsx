...
export const NavBar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container flex items-center justify-between md:justify-between relative z-50">
          ...
          <button
            ...
            className="md:hidden p-2 text-foreground z-[60] relative ml-auto"
      ...
      {isOpen && (
        <div 
          className="fixed inset-0 w-screen h-screen bg-background/95 backdrop-blur-md z-[55] flex flex-col items-center justify-center md:hidden"
          style={{
            position: 'fixed',
            top: 0,
            left: 0,
